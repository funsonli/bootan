...
import com.funsonli.bootan.module.base.dao.RolePermissionDao;
import com.funsonli.bootan.module.base.entity.RolePermission;
import com.funsonli.bootan.module.base.mapper.RolePermissionMapper;
...
public class RolePermissionServiceImpl implements RolePermissionService {
    ...
    @Autowired
    private RolePermissionDao modelDao;


    @Autowired
    private RolePermissionMapper modelMapper;
    ...
    public Page<RolePermission> findByCondition(RolePermission model, SearchVO searchVO, Pageable pageable) {
        return modelDao.findAll(new Specification<RolePermission>() {
            @Nullable
            @Override
            public Predicate toPredicate(Root<RolePermission> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
